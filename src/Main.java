               ...
               switch (selection) {
                  ...
                  case 2 -> {
                     ...
                     Expense latestExpenseID = new Expense( //need to place logic around grabbing expense ID from Expense
                             ...
                             enterString("Expense Type - \'Entertainment\', \"Travel\", \"Office Supplies\" or \"Other\""), //need to add selection from array
                             enterString("Expense Currency - \"GBP\", \"EUR\", \"BGN\", \"PLN\", \"LEV\", or \"RON\""), //need to add selection from array
